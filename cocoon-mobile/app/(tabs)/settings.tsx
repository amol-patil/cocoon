...
import {
  isModelDownloaded, downloadModel, releaseContext, deleteModel,
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <SectionLabel label="DOCUMENT AI" />
        <View style={styles.card}>
          <View style={styles.settingRow}>
            <Feather name="cpu" size={22} color={colors.accentPrimary} style={styles.settingIcon} />
            <View style={styles.settingInfo}>
              <Text style={styles.settingLabel}>On-Device AI Model</Text>
              <Text style={styles.settingSubtitle}>
                Powers document scanning and field extraction
              </Text>
            </View>
          </View>
          <View style={styles.cardDivider} />
          <View style={styles.settingRow}>
            <View style={styles.settingInfo}>
              <Text style={styles.settingSubtitle}>Status</Text>
              <Text style={styles.settingLabel}>
                {downloadPct >= 0
                  ? `Downloading ${Math.round(downloadPct * 100)}%`
                  : modelReady ? 'Installed (~1 GB)' : 'Not installed'}
              </Text>
            </View>
            <View style={styles.settingRight}>
              {downloadPct >= 0
                ? <ActivityIndicator color={colors.accentPrimary} />
                : modelReady
                  ? <TouchableOpacity onPress={handleDeleteModel}><Text style={[styles.valueText, { color: colors.error }]}>Delete</Text></TouchableOpacity>
